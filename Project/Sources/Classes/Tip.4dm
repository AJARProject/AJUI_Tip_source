...
Function AutoRebuild
	...
	If (Count parameters:C259=0)
		$0:=AJUI_Tip_setAutoRebuild 
	Else 
		AJUI_Tip_setAutoRebuild ($1)
	End if 
...
Function ActivateOnClickCB
	...
	If (Count parameters:C259=0)
		$0:=AJUI_Tip_onClickCB 
	Else 
		AJUI_Tip_onClickCB ($1)
	End if 
